...
if __name__ == '__main__':
    ...
    ae4ad_reformer = load_model("D:\\Things\\PyProject\\AE4AD\\Data\AE4AD\\autoencoder_mnist_cnn_model_softmax_0348", compile=False)
    ...
    summary_result_path = result_path + "ae4ad_mnist_summary.csv"
