...
from detector import LpNormDetector

if __name__ == '__main__':
    # ae_reformer = load_model("D:\\Things\\PyProject\\AE4AD\\Data\\MagNet\\best_trained_magnet_reformer\\mnist_magnet_0.01")
    # ae_reformer = load_model("D:\\Things\\PyProject\\AE4AD\\Data\\MagNet\\best_trained_magnet_reformer\\mnist_magnet_0.025")
    ae_reformer = load_model("D:\\Things\\PyProject\\AE4AD\\Data\\MagNet\\best_trained_magnet_reformer\\mnist_magnet_0.05")

    ae_detector = load_model("D:\\Things\\PyProject\\AE4AD\\Data\\MagNet\\best_trained_magnet_detector\\detector_magnet_mnist")

    classifier = load_model("D:\\Things\\PyProject\\AE4AD\\Data\\CNN\\mnist_classifier\\mnist_cnn_model.h5")

    detector_I = LpNormDetector(ae_detector, p=2)
    ...
    images_path = "D:\\Things\\PyProject\\AE4AD\\Data\\ADV\\mnist_test_adv\\adv"
    labels_path = "D:\\Things\\PyProject\\AE4AD\\Data\\ADV\\mnist_test_adv\\label"

    result_path = "D:\\Things\\PyProject\\AE4AD\\Data\\MagNet\\"
    # summary_result_path = result_path + "mnist_summary_0.01.csv"
    # summary_result_path = result_path + "mnist_summary_0.025.csv"
    summary_result_path = result_path + "mnist_summary_0.05.csv"
    ...
    images_test = np.load("D:\\Things\\PyProject\\AE4AD\\Data\\CNN\\mnist_classifier\\mnist_test_data.npy")
    labels_test = np.load("D:\\Things\\PyProject\\AE4AD\\Data\\CNN\\mnist_classifier\\mnist_test_label.npy")
